...
const REFERENCE_LIBRARY = [
  ...
  { cat: "form", title: "DS2444A — Disability Income Assistance Application", desc: "The new combined AISH + ADAP application form, live as of July 2026 \u2014 the form you complete to apply (or reapply, through reassessment) for disability income assistance. Goes in together with your health professional's medical report (DS2444B).", file: "/pdfs/government-form-originals/government-forms/DS2444A \u2013 Disability Income Assistance Application.pdf", released: "2026-07-02" },
  { cat: "form", title: "DS2444B — Disability Assistance Medical Report", desc: "The medical half of the disability assistance application, completed by your health professional (doctor, and in some cases other practitioners). Submitted alongside your own application form (DS2444A).", file: "/pdfs/government-form-originals/government-forms/DS2444B \u2013 Disability Assistance Medical Report.pdf", released: "2026-07-02" },
