...
const DOCUMENTS = [
  ...
  { cat: "plain", title: "Bill 12, Section 6 — Plain Language Breakdown", desc: "What Section 6 of Bill 12 actually does, in plain language — the legislative change behind the AISH-to-ADAP transition, read line by line and explained for non-lawyers.", file: "/pdfs/plain-language/Bill12_Section6_Plain_Language_Breakdown.pdf", released: "2026-06-20" },
  { cat: "plain", title: "Regulation AR 96/2026 — Plain Language Breakdown", desc: "The ADAP regulation (AR 96/2026) translated out of legal language — what the rule says, what it changes, and what it means for AISH recipients being moved to ADAP.", file: "/pdfs/plain-language/AR96-2026_Plain_Language_Breakdown.pdf", released: "2026-06-20" },
  ...
  { cat: "new", title: "The \"Not In Force\" Pattern — Legal Memo", desc: "A legal memo documenting the pattern of people being told they cannot appeal under rules that were not yet in force before July 2 \u2014 the timing problem at the heart of the transition, set out for lawyers and advocates.", file: "/pdfs/new-adsb-docs/AISH_ADAP_Not_In_Force_Pattern_LegalMemo_June2026.pdf", released: "2026-07-05" },
  { cat: "new", title: "AISH vs. ADAP — Cheat Sheet", desc: "A one-page quick-reference comparing AISH and ADAP \u2014 the key numbers and rules at a glance, for fast answers.", file: "/pdfs/new-adsb-docs/AISH_vs_ADAP_Cheat_Sheet.pdf", released: "2026-07-05" },
  { cat: "new", title: "AISH vs. ADAP — Language Deep Dive", desc: "A close reading of how AISH and ADAP are described in the government's own words \u2014 the language shifts that change what the programs actually promise.", file: "/pdfs/new-adsb-docs/AISH_vs_ADAP_Language_Deep_Dive.pdf", released: "2026-07-05" },
  { cat: "new", title: "AR 96/2026 — Key Sections Highlighted", desc: "The ADAP regulation (AR 96/2026) with its key sections marked and highlighted \u2014 the provisions that matter most, pulled out so you don't have to hunt for them.", file: "/pdfs/new-adsb-docs/AR96-2026_Key_Sections_Highlighted.pdf", released: "2026-07-05" },
  { cat: "new", title: "Bill 12, Section 6 — Key Provisions Highlighted", desc: "Bill 12, Section 6 (the legislative change behind the transition) with its key provisions marked and highlighted for quick reference.", file: "/pdfs/new-adsb-docs/Bill12_Section6_Key_Provisions_Highlighted.pdf", released: "2026-07-05" },
  ...
  { cat: "info", title: "The Premier's Words and the Record", desc: "Public statements made about the AISH-to-ADAP changes, set beside the documented record \u2014 the regulations, the figures, and the official sources \u2014 so you can compare what was said with what the paper trail shows. Every claim is sourced; you can check each one yourself.", file: "/pdfs/july-2026-docs/The_Premiers_Words_And_The_Record_June2026.pdf", released: "2026-07-05" },
...
const REFERENCE_LIBRARY = [
  ...
  { cat: "form", title: "T2201 — Disability Tax Credit Certificate (Part A)", desc: "The CRA's Disability Tax Credit certificate, Part A (the section you complete). The DTC is the key that unlocks the federal Canada Disability Benefit. See the plain-language DTC guide in Documents for a walkthrough.", file: "/pdfs/government-form-originals/government-forms/T2201_DTC_PartA.pdf", released: "2026-07-05" },
  ...
  { cat: "infopage", title: "Pharmacy Providers (Alberta Blue Cross)", desc: "Alberta Blue Cross info page on pharmacy providers and prescription coverage.", file: "/pdfs/government-form-originals/info-pages/Pharmacy providers _ Alberta Blue Cross\u00ae.pdf", released: "2026-07-05" },
  { cat: "infopage", title: "Pharmacy Benefact 1256", desc: "Alberta Blue Cross pharmacy bulletin (Benefact 1256) on prescription benefit details.", file: "/pdfs/government-form-originals/info-pages/pharmacy-benefact-1256.pdf", released: "2026-07-05" },
  { cat: "infopage", title: "Foot Care Help in Alberta for a Low-Income Adult", desc: "Information on accessing foot care in Alberta for low-income adults \u2014 the source behind the plain-language foot-care guide in Documents.", file: "/pdfs/government-form-originals/info-pages/Foot Care Help in Alberta for a Low-Income Adult.pdf", released: "2026-07-05" },
  ...
  { cat: "infopage", title: "Government Correspondence — DIA Forms (July 2026)", desc: "Email correspondence confirming the new DS2444 disability income assistance forms and submission details.", file: "/pdfs/government-form-originals/info-pages/Mail - Outlook.pdf", released: "2026-07-02" },
