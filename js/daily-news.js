/* ───────────────────────────────────────────────────────────────
   ...
   Plain-language daily updates on the AISH → ADAP transition.

   TO ADD A NEW DAY: copy one block, put it at the TOP of the array
   (newest first), set the date (YYYY-MM-DD) and title, and paste the
   post text into body. In body: a line starting with "## " is a
   heading; blank lines separate paragraphs. That's the whole format.
   ─────────────────────────────────────────────────────────────── */
const DAILY_NEWS = [
{
  date: "2026-06-29",
...
## WHAT HAPPENS IN JULY
On the July benefit period, every person on AISH is automatically moved to the new program, ADAP, unless you fall into one of the groups that stay on AISH automatically. Program messaging says July 1, the law says July 2, so you will see both dates. Roughly 79,000 of us are in this transition.

## THE MONEY
ADAP pays $1,740 a month. AISH is $1,940. That is $200 a month less. But if you are on AISH now and you get moved, a $200 top-up holds your payment at your current amount until December 31, 2027. The cut lands in January 2028. So this is a cut on a timer, not extra money. And one more thing that matters long term: AISH and ADAP are no longer tied to inflation. Raises now only happen if the government chooses to make one. Plan for the cut now, while there is time.

## WHO STAYS ON AISH WITHOUT DOING ANYTHING
You stay on AISH automatically, and you do not need to act, if you have a severe or profound developmental disability or are eligible for PDD services, have a palliative or terminal condition, live in continuing care, or are 60 or older. If that is you, you are not being moved. If you fit one of these and still got an ADAP letter, that is likely an error worth flagging — we are seeing those corrections happen.

## IF YOU ARE MOVED AND YOU CANNOT WORK
You can ask to be reassessed and stay on AISH. There is no deadline for this, and the government covers one medical assessment. You do not need a brand new diagnosis. You lean on the evidence you already have, your specialist letters, your history, anything that shows your disability and that it has not changed. One important tip: ask your doctor to speak to whether your condition is permanent or long lasting, and how it affects your ability to work. Those two things are what AISH actually decides on, and a letter that only lists diagnoses can fall short. Start the application at aish.alberta.ca, or call Alberta Supports at 1-877-644-9992. Begin it now if you like, but do not submit before July 2, because new questions get added then and sending the old version early just slows you down.

## THE APPEAL WINDOW CLOSES JUNE 30
Short and important. The move itself cannot be appealed, and the medical panel decision is final. But if you have an AISH decision already on your file that you want to challenge, the old appeal window closes June 30. Appealing and asking to be reassessed are two separate paths, and you can do both. I filed my own appeal already. It may not change the outcome, but you either keep a right, or you put on the record that it was taken. The Appeals Secretariat is at 780-427-2709 or alss.appeals@gov.ab.ca.

## YOUR FEDERAL MONEY AND YOUR TAXES (PLEASE READ THIS ONE)
The federal Canada Disability Benefit goes up to about $204 a month for the July benefit year. Here is what matters for us in Alberta. We are the only province that claws this money back dollar for dollar, so most of us will see no extra cash from it. But you still have to keep your application for it active, or you get docked $200 a month whether you receive the benefit or not. So if you have not filed your 2025 taxes, please file them now. From July the federal benefit uses your 2025 return, and an unfiled return can pause everything and trigger that penalty. Filing protects you.

## AUGUST, IF YOU ARE A COUPLE
Starting in the August benefit period, two changes hit households where both partners get AISH or ADAP. First, you will each get 88 percent of the full amount instead of the full amount. Second, the income exemption for a working spouse or partner is being cut from $2,612 to $1,500. One couple told the news they expected the transition loss but not the extra roughly $470 a month they lose just for being a couple living together. If this is you, plan for it now.

## GET YOUR OWN FILE
Worth knowing: you can request a full copy of your own AISH file for free, because it is your own information. It lets you see what is actually on record, and catch any gaps, before a reassessment. You request it through the Access to Information service at alberta.ca. They have 30 days to respond and tell you the next steps; the actual file can take a bit longer to arrive, so request early.

## ADD YOUR VOICE
There is a ready-to-send accountability submission in the Take Action section now — you can fill it in with your own story and send it to the Minister, your own MLA, and across every party. Your story is the evidence. A growing list of city and town councils — Edmonton, Calgary, Red Deer, Lethbridge, Camrose, Claresholm, Rocky Mountain House, Cold Lake — have publicly asked the province to pause and rethink this. We are not alone, and we are not quiet.
...
## THE BIG DATE
The change takes effect July 2. Most people on AISH now will be moved to the new ADAP program. About 30,000 people with the most severe conditions, or who are 60 and older, stay on AISH automatically and do not need to do anything. The rest, around 50,000, are moved to ADAP.

## WATCH YOUR MAIL
The government is sending letters telling you which program you land on. If you have not received yours, call Alberta Supports at 1-877-644-9992 and ask. Do not sit and wonder.

## YOUR MONEY, NOW AND LATER
AISH pays $1,940 a month. ADAP pays $1,740, which is $200 less. But if you are moved, a temporary $200 top-up holds your payment at $1,940 until December 31, 2027. So your amount does not drop right away. The real cut lands in January 2028. That roughly 18 month cushion is what people mean when they mention "18 months." It is the top-up period, not a deadline to do anything.

## COUPLES, STARTING IN AUGUST
If you and your partner both receive disability benefits, starting with the August payment period you will each receive 88 percent of the maximum instead of the full amount. For two-recipient couples, that is a real loss of money.

## THE FEDERAL BENEFIT, AND A TRAP TO AVOID
The federal Canada Disability Benefit is about $200 a month, rising to $204 in July. Alberta is the only province that claws it back dollar for dollar, so for people on AISH or ADAP it adds no money. But here is the trap: you still have to apply for it, or confirm your application, because not doing so can trigger a $200 cut to your provincial benefit anyway. Apply even though it feels pointless. It protects you.

## WORKING, AND A NUMBER THEY STILL HAVE NOT PUBLISHED
On ADAP you can earn up to $700 a month before they touch your benefit, lower than the old AISH amount. If you have a working partner, less of their pay is protected too. And here is the part to be angry about: with launch less than a month away, the government still has not published how fast they claw back money you earn above $700. That number is the single biggest unknown for anyone who works, and they have not put it on paper.

## IF YOU ARE MOVED BUT YOU CANNOT WORK
You cannot appeal the decision that puts you on ADAP instead of AISH. That door is closed by the new rules. But you can ask for a reassessment to get back on AISH, and there is no deadline on it. The government covers the cost of one medical assessment. If your condition prevents you from earning a living, that is the path, and we can walk you through it.

## A LITTLE GOOD NEWS
Getting the federal Disability Tax Credit just got easier. Occupational therapists, physiotherapists and speech-language pathologists can now fill out the form, not only doctors, which means less cost and less waiting. The tax credit is the doorway to the federal benefit, so it is worth doing.

## YOU ARE NOT ALONE IN THIS
A growing list of cities and towns, Edmonton, Calgary, Lethbridge, Red Deer, Camrose and more, have formally asked the province to slow down and reconsider these changes. Disability organizations are pushing for the same. The pressure is real and it is building.

That is where things stand tonight. If any of this raised a question about your own situation, ask it here. That is what this page is for. We will keep watching, keep translating, and keep going, together.`
},
{
  date: "2026-06-05",
  title: "Where Things Stand — June 5, 2026",
  body: `Plain version of where things sit tonight. We are about 27 days out. A couple of new things surfaced today underneath the big transition, and they matter.

## THE BIG DATE
July 2 is when the change becomes law (the program says July 1). Most people on AISH are moved to the new ADAP program. About 30,000 with the most severe conditions, or aged 60+, stay on AISH automatically. The rest, about 50,000, move.

## YOUR MONEY
AISH is $1,940 a month. ADAP is $1,740, which is $200 less. If you are moved, a temporary $200 top-up holds you at $1,940 until December 31, 2027. The real drop is January 2028. Your amount does not change right away.

## TWO NEW THINGS TO KNOW ABOUT
First, there is a new six-month cap coming on regular Income Support for people the government says are "not meeting expectations" — projected to save the province $44 million next year and far more after that. That is the wider safety net many disabled and disability-adjacent Albertans rely on getting smaller. Second, underneath the ADAP rebrand sits a roughly $49 million cut to AISH funding, and three disability-advocacy contracts were ended a full year early. The organizations that speak up for you are being defunded at the same time the system changes.

## THE FEDERAL BENEFIT
The federal Canada Disability Benefit resets July 1, rising from $200 to $204 a month. Alberta still claws it back dollar for dollar, so most recipients net nothing from it. Keep applying or confirming your application anyway — not doing so can trigger a $200 cut to your provincial benefit.

## COUPLES
From the August payment period, couples where both partners get disability benefits each receive 88 percent of the maximum. A couple in Consort told the news this stacks with the $200 cut to roughly $470 a month lost. Real money, real households.

## IF YOU CANNOT WORK
You cannot appeal being moved to ADAP, but you can ask for a reassessment to return to AISH, with no deadline, and the province covers one medical assessment. If you can't earn a living, that is your path.

That is where things stand tonight. Bring your questions here — that is what this page is for. We keep watching, and we keep going, together.`
},
{
  date: "2026-06-04",
  title: "Where Things Stand — June 4, 2026",
  body: `Here is the plain version tonight. We are about four weeks from the change. The "couples penalty" is now front-page news, and it deserves a clear explanation.

## THE BIG DATE
July 2 is the legal date (the program says July 1). Most people on AISH move to ADAP. About 30,000 with the most severe conditions, or aged 60+, stay on AISH automatically; about 50,000 move.

## COUPLES — WHY IT IS IN THE NEWS
A couple in Consort, both disabled and unable to work, told Global News they will lose about $470 a month. Here is the math: the $200 ADAP cut, stacked on a new rule that, from the August payment period, pays each partner in a two-recipient household only 88 percent of the maximum instead of the full amount. If you and your partner both receive disability benefits, this is the change to watch.

## YOUR MONEY
AISH is $1,940; ADAP is $1,740, which is $200 less. A temporary $200 top-up holds movers at $1,940 until December 31, 2027. The real cut is January 2028 — your amount does not drop right away.

## WATCH YOUR MAIL
Letters are telling people which program they land on. If yours hasn't arrived, call Alberta Supports at 1-877-644-9992. Don't sit and wonder.

## NO PAUSE — BUT PRESSURE IS BUILDING
ADAP's program details are now published, and the new minister has been publicly active. The province has not granted a pause, despite formal requests from Red Deer, Edmonton, Lethbridge, Camrose, Calgary, Claresholm and Rocky Mountain House. The pressure is real and growing.

## IF YOU CANNOT WORK
You can't appeal the move to ADAP, but you can ask for a reassessment to get back on AISH — no deadline, and the province covers one medical assessment.

That is where things stand tonight. If any of this raised a question about your situation, ask it here. We keep watching, keep translating, and keep going, together.`
},
{
  date: "2026-06-03",
  title: "Where Things Stand — June 3, 2026",
  body: `Plain version of where things sit tonight, about four weeks out. The clearest picture of the human cost yet came out today.

## A REAL FAMILY, REAL NUMBERS
Global News reported today on a married couple in Consort. Both are disabled, both cannot work, and together they are losing about $470 a month — the $200 ADAP cut plus the couple's reduction. This is what the change looks like for two-recipient households, in dollars, for people the system claims it is "helping into work."

## THE BIG DATE
ADAP launches July 1; the legal date is July 2. Most current AISH recipients move to ADAP unless they meet a retention rule (most severe conditions, or 60+).

## YOUR MONEY
AISH $1,940, ADAP $1,740 — $200 less. A $200 top-up holds movers at $1,940 until December 31, 2027; the real cut is January 2028.

## COUPLES, FROM AUGUST
From the August payment period, each partner in a two-recipient household gets 88 percent of the maximum, not the full amount.

## A NUMBER STILL MISSING
With under a month to go, the government still has not published how fast it claws back money you earn above the $700 ADAP work exemption. For anyone who works, that is the biggest unknown, and it is still not on paper.

## YOU ARE NOT ALONE
Advocates like Inclusion Alberta and Friends of Medicare, along with a growing list of municipalities, are publicly calling for a pause to the transition. The push is building.

That is where things stand tonight. Bring your questions here. We keep watching, and we keep going, together.`
},
{
  date: "2026-06-02",
  title: "Where Things Stand — June 2, 2026",
  body: `Here is the plain version tonight. We are about a month out — 30 days.

## THE BIG DATE
The legal change comes into force July 2 (the program says July 1). By law, every current AISH recipient is moved to ADAP unless they meet a rule that keeps them on AISH — the most severe conditions, PDD, palliative or terminal, continuing care, or age 60+.

## YOUR MONEY
AISH pays $1,940 a month; ADAP pays $1,740, which is $200 less. If you are moved, a temporary $200 top-up holds you at $1,940 until December 31, 2027. The real cut lands January 2028.

## THE FEDERAL BENEFIT, AND THE TRAP
The federal Canada Disability Benefit rises to $204 a month in July. Alberta is still the only province clawing it back dollar for dollar, so on AISH or ADAP you net nothing from it. Apply or confirm your application anyway — skipping it can trigger a $200 cut to your provincial benefit.

## COUPLES, FROM AUGUST
From the August payment period, couples where both get disability benefits each receive 88 percent of the maximum.

## WHO IS RUNNING THIS
The May 21 cabinet shuffle is confirmed: Jason Nixon, who built ADAP, moved to Finance and Treasury Board; Nathan Neudorf now holds the AISH/ADAP file. A new minister is steering the change a month before it lands.

That is where things stand tonight. If something here touches your situation, ask. We keep watching, and we keep going, together.`
},
{
  date: "2026-06-01",
  title: "Where Things Stand — June 1, 2026",
  body: `Plain version to open the month. We are about a month from the change.

## THE BIG DATE
July 2 is the legal date (the program says July 1). Transitioning from AISH to ADAP drops the base rate from $1,940 to $1,740 — cushioned only by a temporary $200 top-up that ends December 31, 2027.

## THE BIGGEST UNKNOWN
Letters went out in mid-May telling people their program. But the criteria that decide who stays on AISH and who moves to ADAP still have not been published in full. With the switch a month away, that is the single biggest open question for the roughly 80,000 people on AISH. If your letter left you unsure, you are not imagining it — the rules underneath it aren't all public.

## COUPLES AND CHILDREN, FROM AUGUST
From the August payment period, the 88 percent couples rule and the recalibrated child-benefit rates take effect. Couples where both partners receive disability benefits each get 88 percent of the maximum. The first-child amount rises, but larger families come out behind.

## WORKING
The clawback rates for money you earn above the work exemption are still delegated to a Ministerial order that has not been released. You still cannot calculate how much of your ADAP benefit you keep as you earn.

## YOUR MONEY
AISH $1,940, ADAP $1,740. The $200 top-up holds movers steady until end of 2027; the real cut is January 2028.

That is where things stand tonight. Bring your questions here. We keep watching, translating, and going, together.`
},
{
  date: "2026-05-31",
  title: "Where Things Stand — May 31, 2026",
  body: `A quiet Sunday, so a short one. The big picture is unchanged: we are about a month from the July 1 / July 2 transition.

## THE BIG DATE
On July 2 (the program says July 1) most current AISH recipients are moved to the new ADAP program. About 30,000 with the most severe conditions, those in continuing care, palliative or terminal, or aged 60+, stay on AISH automatically. About 50,000 move.

## YOUR MONEY
AISH is $1,940 a month; ADAP is $1,740. If you are moved, a $200 transition top-up holds you at $1,940 until December 31, 2027. After that — January 2028 — the $200 cut becomes permanent. New applicants after July 1 get only $1,740, with no cushion.

## YOU ARE NOT ALONE
Cold Lake council voted this week to ask the province to pause the rollout, joining Edmonton, Calgary, Red Deer, Lethbridge, Camrose, St. Albert and others. The list of towns asking the province to slow down keeps growing.

That is where things stand tonight. If you have a question about your own letter or situation, ask it here. We keep watching, and we keep going, together.`
},
{
  date: "2026-05-30",
  title: "Where Things Stand — May 30, 2026",
  body: `Plain version tonight. About five weeks to the change, and the couples rule is getting more attention.

## THE BIG DATE
July 1 / July 2: most people on AISH move to ADAP unless they meet a rule to stay (most severe conditions, continuing care, palliative, or 60+).

## YOUR MONEY
AISH $1,940, ADAP $1,740 — $200 less. A $200 top-up holds movers at the AISH rate only until December 31, 2027; in January 2028 the drop becomes permanent.

## COUPLES — WHAT TO WATCH
Coverage this week followed an Alberta household that stands to lose hundreds of dollars under the cohabitation rule: from the August payment period, each partner in a two-recipient household receives 88 percent of the maximum instead of the full amount. If you and your partner both receive disability benefits, this one hits you directly.

## THE FEDERAL BENEFIT
Alberta still claws back the federal Canada Disability Benefit dollar for dollar on both programs. Keep your application current regardless — not doing so can cost you $200 from the provincial side.

That is where things stand tonight. Questions about your situation are welcome here. We keep watching, and we keep going, together.`
},
{
  date: "2026-05-29",
  title: "Where Things Stand — May 29, 2026",
  body: `A thin news day, so a short, steady update. We are about five weeks out.

## THE BIG DATE
On July 1 / July 2, roughly 50,000 current AISH clients move to ADAP and about 30,000 with the most severe disabilities stay on AISH. ADAP's base is $1,740 versus AISH's $1,940; movers get a $200 top-up running through December 31, 2027. New applicants after July 1 get only $1,740.

## THE FEDERAL BENEFIT
Alberta's dollar-for-dollar clawback of the federal Canada Disability Benefit stays in place. On AISH or ADAP, it adds nothing — but keep applying, because not doing so can trigger a $200 provincial cut.

## YOU ARE NOT ALONE
Another municipality (Cold Lake) has moved to ask the province to pause, adding to the list of councils — Red Deer, Edmonton, Lethbridge, Camrose, Calgary, Claresholm, Rocky Mountain House — pressing for the same.

That is where things stand tonight. If you have a question, ask it here. We keep watching, and we keep going, together.`
},
{
  date: "2026-05-28",
  title: "Where Things Stand — May 28, 2026",
  body: `Plain version tonight, about five weeks from the change. One new town joined the call to slow this down.

## YOU ARE NOT ALONE
Cold Lake has moved to formally ask the province to pause the AISH-to-ADAP rollout — a new name on a growing list that already includes Edmonton, Calgary, Lethbridge, Red Deer, Camrose, St. Albert, Rocky Mountain House, Claresholm and Medicine Hat. Councils across Alberta are telling the province the same thing: slow down and reconsider.

## THE BIG DATE
On July 1 / July 2 most current AISH recipients move to ADAP. From that day, a single combined application opens, and an adjudicator decides AISH or ADAP based on medical evidence and ability to work.

## WORKING
On ADAP, a single client can earn up to $700 a month before benefits are touched, with earnings phasing out toward about $45,240 a year. The exact rate they claw back above $700 is still not published.

## YOUR MONEY
AISH $1,940, ADAP $1,740. The $200 top-up holds movers steady until December 31, 2027; the cut becomes permanent January 2028.

That is where things stand tonight. Bring your questions here. We keep watching, and we keep going, together.`
},
{
  date: "2026-05-27",
  title: "Where Things Stand — May 27, 2026",
  body: `Here is the plain version tonight. We are about five weeks out, and the rollout got its hardest look yet in the press.

## A MAJOR INVESTIGATION
A long-form investigation published today — "Survive on $1,740 a Month" — frames the July transition plainly: a benefit cut affecting roughly 79,000 Albertans. It confirms ADAP's $1,740 maximum against AISH's $1,940, notes the $200 top-up only protects existing recipients moved to ADAP until December 31, 2027, and points out that anyone who applies new after July 1 gets only $1,740 with no cushion. One economist's analysis cited in it estimates about 84 percent of current AISH clients end up worse off.

## YOUR MONEY
AISH $1,940, ADAP $1,740 — $200 less. The May payment landed yesterday at the current AISH rate; this is one of the last cheques before the July cutover. Your amount does not change until the transition.

## THE FEDERAL BENEFIT
Alberta still claws back the federal Canada Disability Benefit dollar for dollar. The automatic $200 clawback still applies to anyone who hasn't told the program their CDB application status — so keep yours current.

## WATCH YOUR MAIL
People are still receiving and making sense of the personalized letters sent in mid-May. If yours hasn't arrived, call Alberta Supports at 1-877-644-9992.

That is where things stand tonight. If something here raised a question about your situation, ask it. We keep watching, and we keep going, together.`
},
{
  date: "2026-05-26",
  title: "Where Things Stand — May 26, 2026",
  body: `Plain version tonight, about five weeks from the change. Payment day came and went; here's what matters.

## YOUR MONEY THIS MONTH
The June-period AISH payment was issued today at the current AISH rate. Nothing has dropped — the first ADAP-era payment is in July. AISH is $1,940; ADAP will be $1,740, with a $200 top-up holding movers at $1,940 until December 31, 2027.

## THE RULES, AND ONE STILL MISSING
The regulations released May 12 set the money, the 88 percent couples rule (from August), the child-benefit changes, and a requirement that ADAP clients judged able to work engage with employment supports. What they still do not define is the line between who stays on AISH and who moves to ADAP — the exact question most people are asking.

## CHILDREN
The first dependent-child benefit rises from $222 to $300 a month, but the amounts fall for later children — so larger families come out behind.

## THE FEDERAL BENEFIT
The May federal Canada Disability Benefit payment landed last week. Alberta remains the only place clawing it back dollar for dollar on AISH/ADAP.

## WHO IS RUNNING THIS
The file changed hands May 21: Nathan Neudorf is now the minister; Jason Nixon, who built ADAP, moved to Finance.

That is where things stand tonight. Questions about your own file are welcome here. We keep watching, and we keep going, together.`
},
{
  date: "2026-05-25",
  title: "Where Things Stand — May 25, 2026",
  body: `Plain version tonight. We are about five weeks out, and the letters are the live story.

## WATCH YOUR MAIL
Decision letters are landing across Alberta this week. About 50,000 people are being told they move to ADAP on July 1; about 30,000 are told they stay on AISH. If your letter hasn't come, call Alberta Supports at 1-877-644-9992 and ask which program you're on. Don't sit and wonder.

## IF YOU DISAGREE WITH YOUR LETTER
If you're told you're moving to ADAP but you can't work, you can apply to stay on or return to AISH and pass a fresh medical assessment. The province covers the cost of one assessment.

## WORKING
On ADAP, a single client can earn up to $700 a month before benefits are touched, with earnings running up to roughly $45,240 a year before they zero out.

## YOUR MONEY
AISH $1,940, ADAP $1,740. The $200 transition top-up holds movers at the AISH rate until December 31, 2027.

## HELP IS ORGANIZING
Advocates in Lethbridge and provincial partners are setting up navigation support to help families through the transition window. You don't have to figure this out alone.

That is where things stand tonight. Bring your questions here. We keep watching, and we keep going, together.`
},
{
  date: "2026-05-24",
  title: "Where Things Stand — May 24, 2026",
  body: `A quiet Sunday with the Legislature adjourned, so a short, steady update. About five weeks to go.

## THE BIG DATE
On July 1 all current AISH clients move to the new ADAP program unless they meet the rules to stay on AISH. ADAP's base is $1,740 a month versus AISH's $1,940; a $200 transition top-up holds transferring clients at the AISH rate until December 31, 2027.

## COMING IN AUGUST
The 88 percent couples reduction and the recalibrated child-benefit rates take effect with the August payment period — not in July. If you and your partner both receive disability benefits, that's the date to mark.

## WHO IS RUNNING THIS
Nathan Neudorf was sworn in May 21 as the minister responsible for AISH and ADAP, taking over from Jason Nixon (now Finance) about six weeks before launch.

That is where things stand tonight. If you have a question about your situation, ask it here. We keep watching, and we keep going, together.`
},
{
  date: "2026-05-23",
  title: "Where Things Stand — May 23, 2026",
  body: `Plain version tonight. The letters are arriving, and a lot of people are shaken. That reaction is reasonable.

## WATCH YOUR MAIL
Individualized letters are reaching recipients now, telling each person whether they stay on AISH or move to ADAP on July 1. Health providers and advocates are reporting real fear and confusion as the letters land. If you've received one and it left you anxious or unsure, you are not alone, and you are not overreacting. If yours hasn't come, call Alberta Supports at 1-877-644-9992.

## WHAT THE RULES SAY — AND DON'T
The regulations filed May 12 set the money: AISH $1,940 for a disability that "permanently prevents" work; ADAP $1,740 for one that "substantially impedes" work. They also set the 88 percent couples rule and the child-benefit changes. What they still do not spell out is the exact line adjudicators use to sort people between AISH and ADAP — the very thing your letter turns on.

## YOUR MONEY
AISH $1,940, ADAP $1,740 — $200 less. Movers get a $200 top-up holding them at $1,940 until December 31, 2027.

## WHO IS RUNNING THIS
A new minister, Nathan Neudorf, took the file on May 21, five to six weeks before launch.

That is where things stand tonight. Bring your questions here — that is what this page is for. We keep watching, and we keep going, together.`
},
{
  date: "2026-05-22",
  title: "Where Things Stand — May 22, 2026",
  body: `Plain version tonight. Roughly six weeks to the July 1 change. No single new bombshell today, but here is the live picture.

## THE BIGGEST OPEN QUESTION
ADAP launches in about six weeks, and the criteria that decide who stays on AISH versus who moves to ADAP still have not been published. For the roughly 80,000 Albertans on AISH, that is the most important unanswered question right now.

## WHO IS RUNNING THIS
Nathan Neudorf was sworn in May 21 as Minister of Assisted Living and Social Services, taking direct control of the file six weeks before launch. Jason Nixon, the previous minister and the architect of the ADAP overhaul, moved to Finance and Treasury Board.

## YOU ARE NOT ALONE
St. Albert council voted 6-0 on May 19 to ask the province to pause the rollout pending consultation — joining Edmonton, Calgary, Red Deer, Lethbridge and Camrose.

## THE FEDERAL BENEFIT
The May Canada Disability Benefit payment was issued May 21. Alberta's dollar-for-dollar clawback from AISH/ADAP stays in place, so keep your application current to avoid a $200 provincial cut.

That is where things stand tonight. If you have a question about your own letter or situation, ask it here. We keep watching, and we keep going, together.`
},
{
  date: "2026-05-01-to-05-21",
  title: "Where Things Stand — Catch-up, May 1–21, 2026",
  body: `This is the catch-up for the first three weeks of May — the period when the whole picture took shape. If you're just finding this page, start here.

## THE DEFINING DAY: MAY 12
On May 12 the province released the final design rules for ADAP and began sending letters to all roughly 80,000 AISH recipients telling each person whether they stay on AISH or move to ADAP on July 1. This is the announcement everything since has been about.

## WHAT THE RULES SET
ADAP's core benefit is $1,740 a month, $200 below AISH's $1,940. Anyone moved from AISH keeps their current amount through a $200 transition top-up that runs until December 31, 2027 — after that, the cut is permanent. New applicants after July 1 get only $1,740. From the August payment period, couples where both partners receive disability benefits each get 88 percent of the maximum, and child-benefit rates are recalibrated (the first child goes up, larger families come out behind). ADAP clients judged able to work must engage with employment supports. The province committed to cover the cost of one medical reassessment for anyone who later seeks to return to AISH.

## WHO STAYS, WHO MOVES
The province expects about 50,000 people to move to ADAP and about 30,000 to stay on AISH — those with severe or profound developmental disabilities, PDD recipients, palliative or terminal conditions, continuing-care residents, and people 60 and older.

## A NEW MINISTER, RIGHT BEFORE LAUNCH
On May 21 a cabinet shuffle handed the AISH/ADAP file to a new minister, Nathan Neudorf, just six weeks before launch. Jason Nixon, who had run the file and defended it, moved to Finance and Treasury Board.

That is where things stood at the end of May 21. From here, the daily updates pick it up day by day. We keep watching, and we keep going, together.`
}
];
